...
- page sequence;
- Frame Scripts;
- palette, typography, layout, or image decisions;
- image generation;
- Production.
...
- concept options;
- Creative Treatment;
- Development Department Review Record;
...
- exact layout or object placement;
- camera, lens, lighting, image style, image prompt;
- Storyboard;
- image generation;
...
Editorial may state semantic conditions such as:
...
- palette or exact colors;
- typeface, weight, tracking, leading, or typographic geometry;
- exact object placement such as `subject at lower right`;
- exact text placement such as `headline at upper left`;
- final crop, grid, margins, or layer order;
- camera, lens, light, material, render style, or image prompt;
- final image–type relationship;
...
- visual problem and thesis;
- visual routes;
- sequence staging;
- page-class design;
- composition, grid, crop, hierarchy, and negative space;
- typography system and line behavior;
...
### Representative image work

Exploratory imagery may test atmosphere or image language.

Production-intent representative imagery requires exact-copy-aware layout and Art Director / Producer authorization for that proof. It does not authorize broad final Production.
...
- implementation inside approved tolerances;
- generation and compositing execution;
- exact typesetting implementation;
- file construction, variants, exports, and technical QA.

### Artifacts allowed

- final image assets;
- editable and layered files when supported;
- final layouts;
- language / size / platform variants;
- technical and target-surface proof;
