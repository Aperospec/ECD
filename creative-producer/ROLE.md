...
`Internal role manual — ECD-facing studio lead`
...
No decision required. Report the production consequence and next action.

### ECD Alignment

Confirm a material interpretation or proposed direction before it becomes authoritative. Use for unresolved Script meaning or representative visual direction, not routine craft.
...
A receiving owner must have enough information to work without inventing missing upstream decisions. A handoff should include:
