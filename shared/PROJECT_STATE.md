...
Project State is Creative Producer's authoritative record of current phase, active capabilities, valid artifacts, quality state, authority state, Producer Review, feedback closure, copy-aware readiness, formally released next actions, locks, open issues, and next valid action.
...
Current formally released action:
Release authority / Producer Review Record:
Current objective:
Next valid action:
...
## Artifact register
| Artifact | Version | Professional owner | Quality state | Authority state | Producer Review | Released next use | Decision Contract / dependencies | Handoff Ready |
|---|---|---|---|---|---|---|---|---|
| Creative Treatment | | | | | | | | |
| Greenlight Record | | | | | | | | |
| Creative Script | | | | | | | | |
...
Layout Map versions:
Layout Map specialist self-QA:
Layout Map Producer Review Records:
Layout Map disposition by screen / class:
Production-intent proof actions released:
...
- Producer Review status, released next action, and recommendation;
...
### Storyboard to Production-intent proof readiness

Requires:

- exact copy and target geometry;
- Copy-Aware Layout Map for each representative screen or valid page class;
- Art Director map self-QA;
- formal map return to Creative Producer;
- Producer Review Record;
- disposition `Producer Cleared for Production-intent proof`;
- explicit image-class declaration;
- named representative proof action.

Until these conditions pass, only valid internal studies and clearly marked Exploratory image-world work may continue. Production-intent image generation, selection, crop, extension, editing, or commitment remains forbidden.

### Production-intent proof to Visual Alignment readiness

Requires:

- Producer Cleared Layout Map reference;
- Production-intent Anchor / Design Comp;
- Art Director visual self-QA;
- representative Type-Fit evidence;
- Producer Review of the representative proof;
- complete ECD-facing visual decision object when ECD authority is required.
...
- Producer Cleared Layout Map coverage for every Production-intent screen or applicable page class;
...
Requires Producer Cleared final package, complete feedback closure, Producer Cleared Layout Map coverage, valid Type-Fit evidence, complete ECD-facing final presentation, and Producer recommendation.
...
- active capabilities or the currently released action are not explicit;
...
- a Producer Review disposition or released next action is missing;
- applicable ECD feedback lacks closure state;
- an ECD decision lacks a complete presentation or recommendation;
- a Production-intent image lacks a Producer Cleared Layout Map and named release action;
...
- anyone other than Creative Producer releases the next formal action or activates the next stage.
