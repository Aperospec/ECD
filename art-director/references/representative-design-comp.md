...
Choose the smallest set that proves the system:
...
It does not lock explicitly provisional defects or refinements left open.

## Quality gate

Art Director self-QA passes when the Comp:
