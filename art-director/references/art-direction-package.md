...
Image–type relationship system:
Evidence / source treatment:
Recurring identifiers:
Variables remaining flexible:

## Copy-Aware Composition System
Exact-copy source:
Copy hierarchy:
...
Value progression:
Color progression:
Scale and viewpoint progression:
Image / type variation:
Opening-to-payoff relationship:
...
Protected subject / face / product / action / evidence zones:
...
Asset direction:
Image-generation / sourcing / editing constraints:
...
Art Direction determines how accepted meaning and exact copy become visual.
...
- Production Artist can execute without inventing creative logic or solving copy fit after the fact;
